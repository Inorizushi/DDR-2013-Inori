...
local path = THEME:GetAbsolutePath("Graphics/ScreenSelectStyle Scroll/Double/")
...
t[#t+1] = Def.ActorFrame{
  ...
  Def.Sprite{
    ...
    OnCommand=function(self) self:diffusealpha(0):zoomy(0) end;
  ...
  LoadActor("infoPad")..{
    InitCommand=function(s) s:xy(160,34):diffusealpha(0) end,
    OffCommand=function(s) s:smooth(0.1):diffusealpha(0) end,
    GainFocusCommand=function(s) s:diffusealpha(0):sleep(0.1):smooth(0.2):diffusealpha(1) end,
  };
  Def.ActorFrame{
    InitCommand=function(s) s:y(-94):diffusealpha(0) end,
  ...
  Def.Sprite{
    ...
    InitCommand=function(s) s:y(72):diffusealpha(0) end,
    OffCommand=function(s) s:smooth(0.1):y(0):diffusealpha(0) end,
...
t[#t+1] = Def.ActorFrame {
  ...
  Def.ActorFrame{
    ...
    LoadActor("Character") .. {
      InitCommand=function(s) s:zoomx(0.9):xy(18,-10):fadebottom(0.4) end,
      OffCommand=function(s) s:smooth(0.2):zoom(0):diffuse(Alpha(Color.Black,0)) end,
...
t[#t+1] = Def.ActorFrame{
  Def.Sprite{
    Texture="title small",
    InitCommand=function(s) s:diffusealpha(0):xy(158,-190):zoom(1.75):diffusealpha(0) end,
