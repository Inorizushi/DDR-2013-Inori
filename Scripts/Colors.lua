...
GameColor = {
	...
	Difficulty = {
		...
		Hard		= color("#3aec28"),			-- green
		Challenge	= color("#e744ff"),			-- light cyan
		...
		Difficulty_Hard		= color("#3aec28"),		-- green
		Difficulty_Challenge	= color("#e744ff"),		-- purple
...
FullComboEffectColor = {
	TapNoteScore_W1=color("#fefecc");
	TapNoteScore_W2=color("#f6ff37");
	TapNoteScore_W3=color("#00ff2a");
	TapNoteScore_W4=color("#00c0ff");
};
